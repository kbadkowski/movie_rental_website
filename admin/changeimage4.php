...
$sql="update tblmovies set Vimage4=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Obraz 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Obraz 4 Szczegóły</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Aktualny Obraz 4</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from tblmovies where tblmovies.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Zaktualizuj Obraz 4<span style="color:red">*</span></label>
												<div class="col-sm-8">
