...
$sql="update tblmovies set Vimage3=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Obraz 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Obraz 3 Szczegóły</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Aktualny Obraz 3</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from tblmovies where tblmovies.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Zaktualizuj Obraz 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
