...
$query -> execute();
$msg="Informację usunięte pomyślnie";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Subskrypcje</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Szczegóły Subskrypcji</div>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('Na pewno chcesz usunąć?');"><i class="fa fa-close"></i></a>
</td>
