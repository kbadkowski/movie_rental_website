...
$genre=$_POST['genre'];
$sql = "SELECT id from tblmovies where tblmovies.MoviesGenre=:genre";
...
$sql = "SELECT tblmovies.*,tblgenre.GenreName,tblgenre.id as gid  from tblmovies join tblgenre on tblgenre.id=tblmovies.MoviesGenre where tblmovies.MoviesGenre=:genre";
$query = $dbh -> prepare($sql);
$query -> bindParam(':genre',$genre, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="movie-details.php?mvid=<?php echo htmlentities($result->id);?>" class="btn">Wyświetl Szczegóły <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
