  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Moje Opinie</h5>
              ...
              <li>
                <div>
                 <p><?php echo htmlentities($result->Testimonial);?> </p>
                   <p><b>Data Wstawienia:</b><?php echo htmlentities($result->PostingDate);?> </p>
                </div>
                <?php if($result->status==1){ ?>
                 <div class="movie_status"> <a class="btn outline btn-xs active-btn">Aktywny</a>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="movie_status"> <a class="btn outline btn-xs">Czeka na akceptację</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
